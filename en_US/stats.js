...
$scope.stats = {
  ...
  'Swim Speed': new Stat("Swim Speed", function(loadout) {
    ...
    'Ink Recovery Speed (Squid)': new Stat("Ink Recovery Speed (Œ⁄‘Ù)", function(loadout) {
    ...
    'Special Charge Speed': new Stat("Special Charge Speed", function(loadout) {
      ...
      this.desc = "{value}p for special".format({value: Math.floor(loadout.weapon.specialCost / chargeSpeed)})
